  ...
  return (
    <div className="min-h-screen bg-black text-white">
      <div className="flex items-center justify-between p-4 border-b border-[#1a1a1a] sticky top-0 bg-black/90 backdrop-blur-md z-10">
        <Link href="/badges" className="text-[#888] active:text-white transition-colors p-2 -ml-2">
          ← Cancel
        </Link>
        <h1 className="font-bold tracking-widest uppercase text-sm">Upload Badge</h1>
      ...
      <div className="p-4 max-w-md mx-auto mt-4">
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex flex-col items-center gap-4">
            <div 
              className="w-32 h-32 rounded-lg border-2 border-dashed border-[#333] flex flex-col items-center justify-center bg-[#0a0a0a] overflow-hidden relative cursor-pointer"
            ...
            >
              {photoPreview ? (
                ...
                <div className="text-center p-4">
                  ...
                  <span className="text-xs text-[#555] uppercase tracking-widest">Image</span>
                </div>
              )}
            </div>

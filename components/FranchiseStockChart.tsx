    ...
    <div className="bg-[#0a0a0b] border border-[#222] hover:border-[#333] p-5 rounded-2xl shadow-2xl transition-all space-y-4 text-left">
      ...
      <div className="flex items-center justify-between pt-1">
        <div className="text-[10px] font-mono text-[#888]">
          ...
          <span className="text-white font-bold">{franchise.user_shares_count || 0}% ({franchise.user_shares_count || 0} Shares)</span>
        </div>

        <button
          type="button"
          onClick={() => setIsBuyModalOpen(true)}
          className="h-10 px-5 bg-gradient-to-r from-emerald-500 to-emerald-400 hover:brightness-110 text-black text-xs font-black uppercase tracking-wider rounded-xl shadow-lg transition-all active:scale-95 flex items-center gap-1.5"
        >
          <span>📈</span>
